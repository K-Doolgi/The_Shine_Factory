...
const BoardEduTechDetail = ({ route }) => {
  ...
  const handleEduEdit = () => {
    if (isLoggedIn && userType === 'admin') {
      navigation.navigate('BoardEduTechEdit', { EducationId: EducationId });
    } else {
      alert('작성 권한이 없습니다.');
    }
  };
      ...
      [ 
        {
          ...
          onPress: () => {
            // 신청 정보를 출력하고 알림창 띄우기
            console.log('신청자 정보:');
            console.log('교육명:', Educationdetail1.EducationInfo.EduName);
      ...
      <View style={styles.boardViewWrap}>
        <View style={styles.boardView}>
          ...
          <View style={styles.content}>
            <Image style={styles.image} source={Educationdetail1.image} />
            <Text>{Educationdetail1.content}</Text>
          </View>
          ...
          <View style={styles.infoItem}>
            ...
            <Text style={styles.infoValue}>{Educationdetail1.EducationInfo.ApplyCount}</Text>
          </View>
          <View style={styles.infoItem}>
            <Text style={styles.infoLabel}>강사이름: </Text>
            <Text style={styles.infoValue}>{Educationdetail1.EducationInfo.Teacher}</Text>
          </View>
        </View>
...
export default BoardEduTechDetail;
