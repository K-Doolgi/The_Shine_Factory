...
const BoardArea = ({ navigation: propNavigation }) => {
  ...
  const paginatedAreaData = AreaData.slice(
  ...
  // 만들고 방치
  const totalPages = Math.ceil(AreaData.length / pageSize);
